...
@section('head')
    <link rel="{{ asset('css/payment.css') }}">
@endsection

@section('content')
    <div class="container py-5">
        <div class="row mb-0 mx">
            <div class="col-lg-8 mx-auto text-center">
                <h1 class="display-4 text-light">Checkout</h1>
            </div>
        </div>
        <div class="row">
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                <form role="form" method="POST" action="{{ route('payment.store') }}">
                                    ...
                                    <div class="form-group"><label for="username">
                                            <h6>Card Owner</h6>
                                        </label> <input type="text" value="Potato Head" name="username" placeholder="Card Owner Name"
                                                        required class="form-control "></div>
                                    <div class="form-group"><label for="cardNumber">
                                            <h6>Card number</h6>
                                        </label>
                                        <div class="input-group"><input value="8364245890263" type="text" name="cardNumber"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="form-group"><label><span class="hidden-xs">
                                                ...
                                                <div class="input-group"><input value="08" type="number" placeholder="MM" name=""
                                                                                class="form-control" required> <input value="2022"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group mb-4"><label data-toggle="tooltip"
                                                ...
                                                </label> <input value="923" type="text" required class="form-control"></div>
                                        </div>
                                    </div>
